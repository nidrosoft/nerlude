...
const ServiceIcon = ({ color }: { color?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
        <path d="M17.5604 8.66977H6.44035C4.60035 8.66977 3.11035 7.17977 3.11035 5.33977C3.11035 3.49977 4.60035 2.00977 6.44035 2.00977H17.5504C19.3904 2.00977 20.8804 3.49977 20.8804 5.33977C20.8804 7.17977 19.3904 8.66977 17.5504 8.66977H17.5604Z" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M12.0003 21.9996C10.7703 21.9996 9.78027 21.0096 9.78027 19.7796C9.78027 18.5496 10.7703 17.5596 12.0003 17.5596C13.2303 17.5596 14.2203 18.5496 14.2203 19.7796C14.2203 21.0096 13.2303 21.9996 12.0003 21.9996Z" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
        <path opacity="0.4" fillRule="evenodd" clipRule="evenodd" d="M12.7505 8.66992C12.7505 8.25571 12.4147 7.91992 12.0005 7.91992C11.5863 7.91992 11.2505 8.25571 11.2505 8.66992V12.3594H8.50047C5.72626 12.3594 3.48047 14.6052 3.48047 17.3794C3.48047 17.7936 3.81626 18.1294 4.23047 18.1294C4.64468 18.1294 4.98047 17.7936 4.98047 17.3794C4.98047 15.4336 6.55468 13.8594 8.50047 13.8594H11.2505V17.5599C11.2505 17.9741 11.5863 18.3099 12.0005 18.3099C12.4147 18.3099 12.7505 17.9741 12.7505 17.5599V13.8594H15.5105C17.4563 13.8594 19.0305 15.4336 19.0305 17.3794C19.0305 17.7936 19.3663 18.1294 19.7805 18.1294C20.1947 18.1294 20.5305 17.7936 20.5305 17.3794C20.5305 14.6052 18.2847 12.3594 15.5105 12.3594H12.7505V8.66992Z" fill={color}/>
        <path d="M19.7796 21.9996C18.5496 21.9996 17.5596 21.0096 17.5596 19.7796C17.5596 18.5496 18.5496 17.5596 19.7796 17.5596C21.0096 17.5596 21.9996 18.5496 21.9996 19.7796C21.9996 21.0096 21.0096 21.9996 19.7796 21.9996Z" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M4.22 21.9996C2.99 21.9996 2 21.0096 2 19.7796C2 18.5496 2.99 17.5596 4.22 17.5596C5.45 17.5596 6.44 18.5496 6.44 19.7796C6.44 21.0096 5.45 21.9996 4.22 21.9996Z" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
);
            ...
            {statItems.map((item) => (
                ...
                >
                    <div className={`flex items-center justify-center size-11 mb-6 rounded-2xl border-[1.5px] ${item.borderColor} ${item.bgColor} ${item.iconColor} max-md:mb-4`}>
                        {item.customIcon === "project" && <ProjectIcon color={item.rawColor} />}
                        {item.customIcon === "service" && <ServiceIcon color={item.rawColor} />}
                        {item.icon && <Icon className={item.iconColor} name={item.icon} />}
                    </div>
