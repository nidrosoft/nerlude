...
const Button: React.FC<ButtonProps> = ({
    ...
    return (
        <Component
            className={`inline-flex items-center justify-center h-12 px-6.5 border-[1.5px] rounded-full text-button transition-all cursor-pointer disabled:pointer-events-none disabled:opacity-50 hover:shadow-hover ${
                isPrimary
                    ? "bg-b-dark1 text-t-light border-transparent fill-t-light hover:bg-b-dark2 dark:bg-b-light1 dark:text-t-dark dark:fill-t-dark dark:hover:bg-b-light2"
                    : ""
            } ${
                isSecondary
